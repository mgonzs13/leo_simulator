...
def generate_launch_description():
    ...
    world_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            get_package_share_directory("leo_gazebo"), "world", "empty.world"),
        description="Gazebo world")

    map_yaml_file = LaunchConfiguration(
        "map",
        default=os.path.join(
            get_package_share_directory("leo_navigation"),
    ...
    ### LAUNCHES ###
    leo_nav_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory("leo_navigation"), "launch", "nav2_bringup.launch.py")),
    ...
    leo_gazebo_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory("leo_gazebo"), "launch", "gazebo.launch.py")),
    ...
    ld.add_action(leo_nav_cmd)
    ld.add_action(leo_gazebo_cmd)
